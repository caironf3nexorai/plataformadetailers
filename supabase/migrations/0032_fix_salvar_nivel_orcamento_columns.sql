-- Migration 0032: Corrigir RPC salvar_nivel_orcamento sem referencias a colunas inexistentes s.preco_base
    ...
    loop
      ...
      if v_combo_id is not null then
        ...
        where cp.combo_id = v_combo_id
          and cp.categoria_id = v_orcamento_rec.categoria_id
