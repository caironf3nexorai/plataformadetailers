    ...
    <PublicLayout>
      <div className="max-w-4xl mx-auto py-4 sm:py-8 px-2 sm:px-4">
        ...
        <div className="space-y-6 text-sm text-vapor-200 leading-relaxed font-sans">
          ...
          {/* Seção 2: Dados Coletados e Bases Legais */}
          <section className="bg-graphite-800/50 border border-graphite-700/50 rounded-xl p-5 sm:p-6 space-y-3">
            ...
            <ul className="space-y-3 list-disc list-inside">
              <li>
                <strong>Assinantes:</strong> Nome, e-mail, telefone, senha criptografada, CNPJ/CPF e histórico de assinaturas. <em>Base Legal: Execução de contrato (Art. 7º, V) e Obrigações Fiscais (Art. 7º, II).</em>
              </li>
              <li>
          ...
          <section className="bg-graphite-800/50 border border-graphite-700/50 rounded-xl p-5 sm:p-6 space-y-3">
            ...
            <p>Não vendemos nem compartilhamos dados para fins comerciais de terceiros. Compartilhamos apenas com provedores de infraestrutura essencial:</p>
            <ul className="space-y-2 list-disc list-inside text-vapor-300 text-xs sm:text-sm">
              <li><strong>Supabase Inc.:</strong> Banco de dados PostgreSQL seguro, autenticação e armazenamento de imagens.</li>
          ...
          <section className="bg-graphite-800/50 border border-graphite-700/50 rounded-xl p-5 sm:p-6 space-y-3">
            ...
            <p>
              Os dados são processados e armazenados em infraestrutura de nuvem segura mantida pela Supabase na região <code className="text-emerald-400 bg-graphite-900 px-1.5 py-0.5 rounded">[REGIÃO DO PROJETO SUPABASE: ex. sa-east-1 (São Paulo, Brasil) ou us-east-1 (Virgínia, EUA)]</code>. Todas as transferências internacionais de dados seguem os padrões de salvaguarda e criptografia estipulados no Artigo 33 da LGPD.
            </p>
          </section>

          {/* Seção 5: Retenção e Expurgo */}
          <section className="bg-graphite-800/50 border border-graphite-700/50 rounded-xl p-5 sm:p-6 space-y-3">
            <h2 className="text-base sm:text-lg font-bold text-emerald-400">
              5. Prazos de Retenção e Expurgo
            </h2>
            <p>
              Fotos de vistoria de entrada e saída são mantidas por tempo indeterminado para prova jurídica do estado do veículo entregue. Fotos de execução de serviços seguem o limite do plano contratado (30 dias no Free, 90 dias no Pro, 365 dias no Studio) e são apagadas de forma automatizada.
            </p>
          </section>
          ...
          <section className="bg-graphite-800/50 border border-graphite-700/50 rounded-xl p-5 sm:p-6 space-y-3">
            ...
            <p>
              Qualquer titular pode solicitar a confirmação de existência, acesso, retificação, portabilidade ou eliminação de seus dados pessoais entrando em contato com nosso Encarregado através do e-mail <code className="text-emerald-400 bg-graphite-900 px-1.5 py-0.5 rounded">[privacidade@plataformadetailers.com.br]</code>. As solicitações são atendidas no prazo legal de até <strong>15 (quinze) dias úteis</strong>.
            </p>
          </section>
